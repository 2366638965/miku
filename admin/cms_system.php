...
?>
			...
			<option value="http://www.caijizy.com/inc/feifei3/" <?php echo ($row['s_cxzy']=='http://jshu8.cn/inc/feifei3/' ? 'selected="selected"':'');?>>极速云</option>
...
?>
													...
													<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
														...
														<span class="help-block">请填写大淘客域名,例：http://kuaishou-1.com/  一定要/结尾</span>
														</div>
													</div>
...
<?php echo'<textarea class="form-control" name="s_jiekou" style="height:200px;" />'.$row['s_jiekou'].'</textarea>
										<span class="help-block">多个解析请用“回车”分开，如：<br>极速解析$http://akhu6.cn/jk.php?url=<br>传奇解析$http://jshu8.cn/jk.php?url=</span>';?>
														</div>
													</div>
												</div>
												<div class="row">
