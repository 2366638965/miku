		...
		<div class="stui-pannel_bd clearfix">
			<ul class="stui-link__pic clearfix">
				<li class="col-md-7 col-sm-4 col-xs-3">
					<a href="http://www.yunziyuan.com.cn/" target="_blank" title=""> <img src="/template/jingpin/img/logo/qq.png"/> </a>
				</li>
				<li class="col-md-7 col-sm-4 col-xs-3">
...
<ul class="stui-link__text clearfix">
	<li><a class="text-color-999" href="http://www.yunziyuan.com.cn" target="_blank">云资源</a></li>
	<li><a class="text-color-999" href="http://www.2020web.cn" target="_blank">微链影院</a></li>
<?php
